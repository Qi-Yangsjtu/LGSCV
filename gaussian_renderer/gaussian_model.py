...
import torch
import numpy as np
from utils.general_utils import inverse_sigmoid, mkdir_p, RGB2SH, strip_symmetric, strip_symmetric, build_scaling_rotation
...
class GaussianModel(nn.Module):
    ...
    def set_attribute(self, points, features_dc, features_rest, opacity, scaling, rotation):
        self._xyz = points
